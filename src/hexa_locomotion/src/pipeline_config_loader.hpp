// Runtime PipelineConfig loader: geometry.yaml + tuning.yaml + gestures.yaml ->
// PipelineConfig. Must stay field-for-field identical to tools/gen_config.py;
// the parity test in test/test_config_loader.cpp enforces it.
#pragma once
